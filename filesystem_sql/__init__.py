...
from filesystem_sql.rotas import v1
from filesystem_sql.rotas.v1 import doc_sphinx
from filesystem_sql.arquivos import descricao_html
from filesystem_sql.excecoes import FilesystemException
from docs import build_html_pages, build_html_static, build_html_source


urllib3.disable_warnings()

logger.add("filesystem_sql.log", rotation="500 MB")
...
app = FastAPI(
    title="DESAFIO TÉCNICO CLICKSIGN - FILESYSTEM",
...
@app.exception_handler(FilesystemException)
async def camara_exception_handler(request: Request, exception: FilesystemException):
    return JSONResponse(
